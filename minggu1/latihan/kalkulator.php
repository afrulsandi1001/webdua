...
<body>
    ...
    <center>
		...
		<form method="post" action="kalkulator.php">			
			<p>bilangan 1 <input type="text" name="bil1" class="bil" autocomplete="off" placeholder="">
            <br>
			<p>bilangan 2 <input type="text" name="bil2" class="bil" autocomplete="off" placeholder="">
